...
Section determ.
  ...
  Lemma reduce_det: forall obs (ws: store_record) (f: frame) es obs1 ws1 f1 es1 obs2 ws2 f2 es2,
      reduce obs ws f es obs1 ws1 f1 es1 ->
      reduce obs ws f es obs2 ws2 f2 es2 ->
      reduce_det_goal obs1 ws1 f1 es1 obs2 ws2 f2 es2 es.
  Proof.
    intros obs ws f es obs1 ws1 f1 es1 obs2 ws2 f2 es2 Hred1 Hred2.
    ...
    cut (forall n, length_rec es < n -> reduce_det_goal obs1 ws1 f1 es1 obs2 ws2 f2 es2 es).
