...
Lemma lfilled_br_and_reduce obs s f es LI obs' s' f' es' i j lh vs k lh' :
...
Lemma lfilled_return_and_reduce obs s f es LI obs' s' f' es' i lh vs k lh' :
  reduce obs s f es obs' s' f' es' ->
  const_list vs ->
...
Lemma llfill_call_host_and_reduce obs s f es LI s' f' obs' es' lh lh' tf h cvs vs :
  reduce obs s f es obs' s' f' es' ->
  const_list vs ->
...
Lemma lfilled_call_host_and_reduce obs s f es LI obs' s' f' es' i lh vs k lh' tf h cvs:
  reduce obs s f es obs' s' f' es' ->
  const_list vs ->
