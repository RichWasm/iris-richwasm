...
Lemma binop_det v1 v2 v op t obs s f obs' s' f' es:
  app_binop op v1 v2 = Some v ->
  reduce obs s f [AI_basic (BI_const v1); AI_basic (BI_const v2); AI_basic (BI_binop t op)] obs' s' f' es ->
  reduce_det_goal obs s f [AI_basic (BI_const v)] obs' s' f' es [AI_basic (BI_const v1); AI_basic (BI_const v2); AI_basic (BI_binop t op)].
Proof.
  move => H Hred.
...
Lemma binop_none_det v1 v2 op t obs s f obs' s' f' es:
  app_binop op v1 v2 = None ->
  reduce obs s f [AI_basic (BI_const v1); AI_basic (BI_const v2); AI_basic (BI_binop t op)] obs' s' f' es ->
  reduce_det_goal Bail s f [AI_trap] obs' s' f' es [AI_basic (BI_const v1); AI_basic (BI_const v2); AI_basic (BI_binop t op)].
Proof.
  move => H Hred.
  by only_one [AI_basic (BI_const v1) ; AI_basic (BI_const v2) ; AI_basic (BI_binop t op)] Hred ;
     inversion Heqes ; subst ; rewrite H in H0 ; inversion H0 ; subst.
