...
Section prim_step_split_properties.
  ...
  Proof.
    ...
    - destruct σ as [[[o s] locs ] inst ].
      destruct Hred as (obs & e1 & [[ [o1 s1] locs1 ] inst1] & efs & (Hes1 & -> & ->)).
      exists [], (e1 ++ es2), (o1, s1, locs1, inst1), [].
      repeat split => //=.
  ...
  Lemma local_frame_lfilled_prim_step_split_reduce_r es1 es2 o s v i n v' i' e2 o2 s2 v2 i2 efs2 obs2 j lh LI :
    lfilled j lh (es1 ++ es2)%list LI ->
    reducible es1 (o,s,v,i) ->
    prim_step [AI_local n (Build_frame v i) LI] (o,s,v',i') obs2 e2 (o2,s2,v2,i2) efs2 ->
    (∃ e' v'' i'' LI', prim_step es1 (o,s,v,i) obs2 e' (o2,s2,v'',i'') efs2 ∧ v' = v2 ∧ i' = i2 ∧ e2 = [AI_local n (Build_frame v'' i'') LI'] ∧ lfilled j lh (e' ++ es2) LI') \/
      ∃ lh0, lfilled 0 lh0 [AI_trap] es1 /\ (o,s,v',i') = (o2,s2,v2,i2) .
  Proof.
    intros Hfill (obs & e1 & [[[o1 s1]  v1 ] i1] & efs & (Hes1 & -> & ->)) (Hstep & -> & ->).
    ...
    - inversion Heqes ; subst n0 f0 es ; clear Heqes.
      ...
      assert (reducible es1 (o, s, v, i)).
      { eexists _, _ , (_,_,_,_), _. repeat split => //=.
        subst ; exact Hes1. }
      destruct f' as [v' i'] eqn:Hf'.
      assert (prim_step LI (o, s, v, i) [] es' (o', s', v', i') []).
  ...
  Lemma local_frame_prim_step_split_reduce_r es1 es2 o s v i n v' i' e2 o2 s2 v2 i2 efs2 obs2 :
    reducible es1 (o,s,v,i) ->
    prim_step [AI_local n (Build_frame v i) (es1 ++ es2)] (o,s,v',i') obs2 e2 (o2,s2,v2,i2) efs2 ->
    (∃ e' v'' i'', prim_step es1 (o,s,v,i) obs2 e' (o2,s2,v'',i'') efs2 ∧ v' = v2 ∧ i' = i2 ∧ e2 = [AI_local n (Build_frame v'' i'') (e' ++ es2)]) \/
      (∃ lh0, lfilled 0 lh0 [AI_trap] es1 /\ (o,s,v',i') = (o2,s2,v2,i2)).
  Proof.
    intros Hred Hprim.
