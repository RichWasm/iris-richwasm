...
Section Fundamental.
  ...
  Proof.
    ...
    iDestruct (big_sepL2_length with "Hlabels") as "%HBlen".
    ...
    1, 2: done.
    iDestruct (values_interp_app with "Hos") as "(%os1 & %os2 & -> & HIos1 & HIos2)"; first done.
    iDestruct (atoms_interp_app with "Hvs") as "(%vs1 & %vs2 & -> & HIvs1 & HIvs2)".
