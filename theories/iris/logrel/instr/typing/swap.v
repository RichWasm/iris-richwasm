    ...
    [MemMM]: {
      ...
      *)
      ...
      - iIntros "Hℓ_heap Hℓ_addr Hrt".
        ...
        open_rt "Hrt".
        iAssert (⌜lm !! ℓ = Some fs⌝%I) with "[Hℓ_layout Hlayout]" as "%Hlmℓ". {
        ...
        iSplitR; first iPureIntro. {
          unfold frame_rel.
          split; last (transitivity (f_inst fr'); done).
        ...
        iExists ((PtrA (PtrHeap MemMM ℓ)) :: os_inner).
        iSplitR "Hatom_target Hℓ_addr".
        + cbn.
          iExists [[PtrA (PtrHeap MemMM ℓ)];os_inner].
          cbn.
          clear_nils.
