...
Definition state : Type := obs * store_record * (list value) * instance.
...
Definition prim_step (e : expr) (s : state) (os : list observation) (e' : expr) (s' : state) (fork_es' : list expr) : Prop :=
  let '(o, σ, locs, inst) := s in
  let '(o', σ', locs', inst') := s' in
    reduce o σ (Build_frame locs inst) e o' σ' (Build_frame locs' inst') e' /\ os = [] /\ fork_es' = [].
...
Lemma val_head_stuck_reduce : ∀ o1 locs1 s1 e1 o2 locs2 s2 e2,
    reduce o1 locs1 s1 e1 o2 locs2 s2 e2 ->
    to_val e1 = None.
Proof.
  move => o1 locs1 s1 e1 o2 locs2 s2 e2 HRed;try by to_val_None_prepend_const.
...
Lemma val_head_stuck : forall e1 s1 κ e2 s2 efs,
  ...
  to_val e1 = None.
Proof.
  rewrite /prim_step => e1 [[[o1 locs1] σ1] inst] κ e2 [[[ o2 locs2] σ2] inst'] efs.
  move => [HRed _].
