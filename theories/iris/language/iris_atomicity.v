...
Proof.
  ...
  { destruct a;try done.
    destruct b;try done. right. right. right. left. eauto.
    destruct v;try done.
    right. right. right. by right. }
  do 1 (destruct e;try done).
  { revert He. cbn. repeat destruct_match_goal.
    all: try by (move => *; right; right; left; repeat eexists).
    move => *. left. repeat eexists. } 
  { destruct e.
...
Lemma atomic_no_hole_load obs s0 f es obs' s' f' es' k lh k0 x0 x1 x2 x3 x4:
  reduce obs s0 f es obs' s' f' es' -> 
...
Lemma atomic_no_hole_store obs s0 f es obs' s' f' es' k lh k0 v x0 x1 x2 x3 x4:
  reduce obs s0 f es obs' s' f' es' -> 
...
Lemma atomic_no_hole_trap obs s0 f es obs' s' f' es' k lh :
  reduce obs s0 f es obs' s' f' es' -> 
...
Lemma reduce_set_global_false obs s0 f obs' s' f' es es' g :
...
Lemma atomic_no_hole_set_global obs s0 f es obs' s' f' es' k lh v g :
  reduce obs s0 f es obs' s' f' es' ->
...
Lemma atomic_no_hole_get_global obs s0 f es obs' s' f' es' k lh g:
  reduce obs s0 f es obs' s' f' es' -> 
