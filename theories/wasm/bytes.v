...
From RichWasm.wasm Require Import common.
...
#[export] Instance EqDec_byte : EqDec.EqDec byte := {
...
Canonical Structure byte_eqType := Eval hnf in Equality.Pack (sort := byte) (Equality.Class byte_eqMixin).
