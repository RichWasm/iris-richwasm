  ...
  [%expect
    {|
      (module
        ...
        (import "richwasm" "gcalloc" (func (;2;) (type 2)))
        (import "richwasm" "setflag" (func (;3;) (type 3)))
        (import "richwasm" "free" (func (;4;) (type 4)))
        (import "richwasm" "registerroot" (func (;5;) (type 5)))
        (import "richwasm" "unregisterroot" (func (;6;) (type 6)))
...
let%expect_test "examples" =
  ...
  [%expect
    ...
    (module
      ...
      (type (;5;) (func (param i32) (result i32)))
      (type (;6;) (func (param i32)))
      (type (;7;) (func (result i32 i32 i32 i32)))
      (type (;8;) (func))
      (import "richwasm" "mem_mm" (memory (;0;) 0))
      (import "richwasm" "mem_gc" (memory (;1;) 0))
      (import "richwasm" "table_next" (global (;0;) (mut i32)))
      ...
      (import "richwasm" "unregisterroot" (func (;6;) (type 6)))
      (import "richwasm" "table" (table (;0;) 0 funcref))
      (func (;7;) (type 7) (result i32 i32 i32 i32)
        i32.const 1
        i32.const 2
        i32.const 3
        i32.const 4
