...
Fixpoint binary_of_be (be : basic_instruction) : list byte :=
  ...
  | BI_load i T_i32 None a o => x28 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i64 None a o => x29 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_f32 None a o => x2a :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_f32 (Some _) _ _ => dummy
  | BI_load i T_f64 None a o => x2b :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_f64 (Some _) _ _ => dummy
  | BI_load i T_i32 (Some (Tp_i8, SX_S)) a o => x2c :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i32 (Some (Tp_i8, SX_U)) a o => x2d :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i32 (Some (Tp_i16, SX_S)) a o => x2e :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i32 (Some (Tp_i16, SX_U)) a o => x2f :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i32 (Some (Tp_i32, _)) _ _ => dummy
  | BI_load i T_i64 (Some (Tp_i8, SX_S)) a o => x30 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i64 (Some (Tp_i8, SX_U)) a o => x31 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i64 (Some (Tp_i16, SX_S)) a o => x32 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i64 (Some (Tp_i16, SX_U)) a o => x33 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i64 (Some (Tp_i32, SX_S)) a o => x34 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_load i T_i64 (Some (Tp_i32, SX_U)) a o => x35 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_store i T_i32 None a o => x36 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_store i T_i64 None a o => x37 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_store i T_f32 None a o => x38 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_store i T_f32 (Some _) _ _  => dummy
  | BI_store i T_f64 None a o => x39 :: binary_of_idx i ++ binary_of_memarg a o
  | BI_store i T_f64 (Some _) _ _ => dummy
  | BI_store i T_i32 (Some Tp_i8) a o => x3a :: binary_of_idx i ++ binary_of_memarg a o
  | BI_store i T_i32 (Some Tp_i16) a o => x3b :: binary_of_idx i ++ binary_of_memarg a o
  | BI_store i T_i32 (Some Tp_i32) _ _ => dummy
